...
import {ActivityIndicator, View,ImageBackground, StyleSheet, TouchableOpacity, Text, Image} from 'react-native';
...
const SplashScreenThird = ({navigation}) => {
  ...
  return (
    ...
    source={require('../../assets/s3bg.jpg')}
    >
    
    <Image 
     source={require('../../assets/s3img.png')} resizeMode='contain' style={{width:'85%',height:'55%'}}  />



    <View style={{width:'100%',alignItems:'center',marginTop:10}}>
      <Text style={{color:'black',fontSize:26,}}>Get Satisfied</Text>
    </View>
...
export default SplashScreenThird;
